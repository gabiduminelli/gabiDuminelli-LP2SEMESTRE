...
public class AlunoGUIListagem extends JDialog {
    ...
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"RA Aluno","data ingresso","cpf"}, 0);
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"RA Aluno","data ingresso","cpf"}, 0);
        int aux = 0;
