...
import Auxiliar.*;
// @author Radames
public class TurmaGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Turma","Codigo Curso","ID Periodo","ID Materia","Maximo Alunos"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public TurmaGUIListagem(List<String> texto, Container cp2) {
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Turma","Codigo Curso","ID Periodo","ID Materia","Maximo Alunos"}, 0);
        int aux = 0;
