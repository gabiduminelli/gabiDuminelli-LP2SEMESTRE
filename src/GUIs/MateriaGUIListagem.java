...
import Auxiliar.*;
// @author Radames
public class MateriaGUIListagem extends JDialog {

    JPanel painelTa = new JPanel();
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Materia","Nome Materia"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public MateriaGUIListagem(List<String> texto, Container cp2) {
        setTitle("Listagem de Materia");
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID Materia","Nome Materia"}, 0);
        int aux = 0;
