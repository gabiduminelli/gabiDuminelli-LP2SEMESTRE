...
public class PessoaGUIListagem extends JDialog {
    ...
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"Cpf","Nome","Idade","email"}, 0);
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Cpf","Nome","Idade","email"}, 0);
        int aux = 0;
