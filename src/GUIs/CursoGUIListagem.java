...
public class CursoGUIListagem extends JDialog {
    ...
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"Codigo Curso","Nome Curso","Situacao"}, 0);
    static JTable tabela = new JTable(modelo);
    JScrollPane scroll = new JScrollPane(tabela);
    List<String> lista = new ArrayList<>();
    public CursoGUIListagem(List<String> texto, Container cp2) {
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"Codigo Curso","Nome Curso","Situacao"}, 0);
        int aux = 0;
